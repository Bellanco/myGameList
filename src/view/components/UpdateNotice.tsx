 ...
 *
 * Va en el mismo hueco que `StatusBanner` y, desde que el aviso es una pieza única (`Notice`), ya no es que se
 * PAREZCA a él: es la misma pieza con otro tono y una acción. A propósito NO es un banner flotante como el de
