  ...
  const formulario = (
    <div className="premios-admin__form">
      ...
      {borrador.options.map((option, index) => (
        <div key={index} className="premios-admin__nominee">
          <input
            className="input"
            type="text"
            value={option.value}
            ...
            <li key={category.id} className="premios-admin__cat">
              <div className="premios-admin__cat-head">
                ...
                <span className="premios-admin__cat-actions">
                  ...
                  >
                    {editando === category.id ? L.cancel : L.edit}
                  </button>
                  <button type="button" className="btn" disabled={busy} onClick={() => eliminar(category)}>
                    {L.remove}
                  </button>
                </span>
              </div>
