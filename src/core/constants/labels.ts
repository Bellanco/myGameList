...
export const SOCIAL_UI = {
  ...
  feed: {
    ...
    activityEmpty: 'Aún no hay actividad de recomendaciones o reseñas para mostrar.',
    ...
    reviewHeadline: (gameName: string) => `Reseñó ${gameName}`,
    recommendationEmpty: 'Sin comentario adicional en la recomendación.',
    showMore: 'Más',
    showLess: 'Menos',
    viewDetail: 'Ver detalle',
    detailTitle: 'Detalle de actividad social',
    detailSubtitle: 'Contenido completo de la recomendación o reseña seleccionada.',
