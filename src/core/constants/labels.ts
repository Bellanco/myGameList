...
export const SOCIAL_UI = {
  ...
  feed: {
    ...
    postsListAria: 'Publicaciones del feed',
    postComposerLabel: 'Comparte una noticia o un enlace',
    postPlaceholder: 'Escribe una publicación… los enlaces (http/https) se vuelven clicables.',
    postPublish: 'Publicar',
    postPublishing: 'Publicando...',
    postPublicNote: 'Las publicaciones son públicas para todo el directorio.',
    postsEmpty: 'Aún no hay publicaciones.',
