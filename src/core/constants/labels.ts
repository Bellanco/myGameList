...
export const SOCIAL_UI = {
  ...
  feed: {
    ...
    identityUid: (uid: string) => `Usuario: ${uid}`,
    identityGist: (gistId: string) => `Gist social: ${gistId.slice(0, 8)}...`,
    identityCollections: 'Colecciones: profiles/friendships/recommendations/activity_events',
  ...
  status: {
    needMainSync: 'Activa primero la sincronización principal para reutilizar el token de GitHub.',
    needGoogleBeforeCreate: 'Identifícate con Google primero para comprobar si ya tienes un gist social en Firestore.',
    gistLinkedFromFirestore: 'Se encontró tu gist social en Firestore y se enlazó automáticamente.',
    gistNotFoundCreated: 'No había gist previo en Firestore. Se creó uno nuevo y quedó enlazado.',
    signInAndLinked: 'Sesión iniciada y gist social recuperado desde Firestore.',
    signInNeedCreate: 'Sesión iniciada. No existe gist social vinculado en Firestore para este usuario; crea uno nuevo.',
    profileMissing: 'Aún no tienes perfil social. Completa tu perfil antes de usar el feed.',
    profileSaved: 'Perfil social guardado en gist y referencia mínima actualizada en Firestore.',
    signOut: 'Sesión social cerrada.',
    invalidSaveContext: 'No hay sesión o configuración social válida para guardar cambios.',
    missingSocialToken: 'No hay token para leer el gist social. Reconfigura la sincronización social.',
    firestoreCheckFailed: 'No se pudo verificar el perfil social en Firestore',
    createGistFailed: 'No se pudo crear el gist social',
    signInFailed: 'No se pudo iniciar sesión con Google',
    loadProfileFailed: 'No se pudo cargar el perfil social',
    saveProfileFailed: 'No se pudo guardar el perfil social',
  },
  steps: [
