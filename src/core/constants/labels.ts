...
export const SOCIAL_UI = {
  ...
  feed: {
    ...
    profileDetailSubtitle: 'Vista pública del perfil seleccionado con sus favoritos y recomendaciones destacadas.',
    ...
    profileRecommendationsTitle: 'Recomendados publicados',
