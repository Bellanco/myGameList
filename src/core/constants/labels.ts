...
export const UI_MESSAGES = {
  ...
  stats: {
    ...
    shame: {
      ...
      rate: 'Índice de abandono por género',
      rateHint: (min: number) => `Solo géneros con al menos ${min} juegos ya decididos.`,
      rateValue: (percent: number, abandoned: number, decided: number) => `${percent}% · ${abandoned} de ${decided}`,
    ...
    wishlist: {
      ...
      oldest: 'Los que más llevan esperando',
    ...
    year: {
      ...
      note: 'Solo aparecen aquí los juegos completados: los abandonados y los próximos no llevan año, así que viven en "General".',
    },
  },
  import: {
    back: 'Volver',
