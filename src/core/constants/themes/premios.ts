...
const PREMIOS_VOICES: Record<PaletteId, ThemePremiosVoice> = {
  ...
  /* Ladrones de corazones: el palacio donde se guarda el recuento no responde. Sin red, el recado no llega a
     Mementos, el Palacio de todos: «Mundo de las Almas» no es de Persona 5, y la app ya dice «Metaverso». */
  persona: {
    error: 'El palacio del recuento no responde.',
    offline: 'Sin señal para bajar a Mementos.',
  },
