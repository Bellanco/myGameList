// «Plata y acero» (steam) — The Witcher: el ACERO del brujo. Metal templado, las cinco señales repartidas por la rampa y el
// fuego de Igni como tinta. La PLATA rellena; Igni escribe.
//
// Su color y su skin: `src/styles/themes/steam/`. Su sitio en el selector: el orden de `THEMES` en
